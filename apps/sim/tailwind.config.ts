  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'ring-pulse': {
          '0%, 100%': {
            'box-shadow': '0 0 0 2px var(--brand-tertiary), 0 0 8px var(--brand-tertiary)',
          },
          '50%': {
            'box-shadow': '0 0 0 5px var(--brand-tertiary), 0 0 16px var(--brand-tertiary)',
          },
        },
        'handle-bounce': {
          '0%, 100%': {
      ...
      animation: {
        ...
        'handle-bounce': 'handle-bounce 2s ease-in-out infinite',
      },
    },
  },
