    ...
    <div className='mx-[14px] overflow-hidden rounded-t-[4px] border border-[var(--border)] border-b-0 bg-[var(--bg-secondary)]'>
      ...
      >
        <div className='flex items-center gap-[6px]'>
          ...
          <span className='font-medium text-[12px] text-[var(--text-primary)]'>{t('copilot.queued.title')}</span>
            ...
            >
              ...
              <div className='flex shrink-0 items-center gap-[4px]'>
                <button
                  ...
                  title={t('copilot.queued.sendNow')}
                >
                ...
                <button
                  ...
                  title={t('copilot.queued.removeFromQueue')}
                >
