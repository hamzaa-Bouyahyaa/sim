...
const UserInput = forwardRef<UserInputRef, UserInputProps>(
  (
    ...
    const effectivePlaceholder =
      placeholder ||
      (mode === 'ask'
        ? t('copilot.input.askAbout')
        : mode === 'plan'
          ? t('copilot.input.planWorkflow')
          : t('copilot.input.planSearchBuild'))
        ...
        >
              ...
              {!disableMentions && (
                <>
                  <Badge
                    ...
                    title={t('copilot.input.insertAt')}
                    className={cn(
                  ...
                  <Badge
                    ...
                    title={t('copilot.input.insertSlash')}
                    className={cn(
                      'cursor-pointer rounded-[6px] p-[4.5px]',
                      disabled && 'cursor-not-allowed'
                    )}
          ...
          <div className='relative mb-[6px]'>
            ...
            <Textarea
              ...
              placeholder={fileAttachments.isDragging ? t('copilot.input.dropFiles') : effectivePlaceholder}
              disabled={disabled}
              rows={2}
