  ...
  return (
    <div className='mb-[2px] last:mb-0' ref={connectionRef}>
      ...
      {isExpanded && hasFields && (
        <div className='relative mt-[2px] ml-[12px] rtl:ml-0 rtl:mr-[12px] space-y-[2px] pl-[10px] rtl:pl-0 rtl:pr-[10px]'>
          <div className='pointer-events-none absolute top-[4px] bottom-[4px] left-0 rtl:left-auto rtl:right-0 w-px bg-[var(--border)]' />
        ...
        return (
          <div key={fieldPath}>
            ...
            {hasChildren && expanded && (
              <div className='relative mt-[2px] ml-[6px] rtl:ml-0 rtl:mr-[6px] space-y-[2px] pl-[10px] rtl:pl-0 rtl:pr-[10px]'>
                <div className='pointer-events-none absolute top-[4px] bottom-[4px] left-0 rtl:left-auto rtl:right-0 w-px bg-[var(--border)]' />
