...
const ACTION_BUTTON_STYLES = [
  'h-[26px] w-[26px] rounded-[6px] p-0',
  'border-2 border-[var(--border-1)] bg-[var(--surface-5)]',
  'text-[var(--text-secondary)]',
  'hover:border-transparent hover:bg-[var(--brand-secondary)] hover:!text-[var(--text-inverse)] hover:shadow-[0_0_8px_var(--brand-secondary)]',
  'dark:border-[var(--border-1)] dark:bg-[var(--surface-7)] dark:hover:bg-[var(--brand-secondary)]',
  'transition-all duration-150',
].join(' ')

const ICON_SIZE = 'h-[13px] w-[13px]'
...
export const ActionBar = memo(
  function ActionBar({ blockId, blockType, disabled = false }: ActionBarProps) {
    ...
    return (
      <div
        className={cn(
          '-top-[50px] absolute right-0',
          'flex flex-row items-center',
          'opacity-0 transition-opacity duration-200 group-hover:opacity-100',
          'gap-[6px] rounded-[8px] p-[6px]',
          'border-2 border-[var(--border-1)] bg-[var(--surface-2)]',
          'dark:border-[var(--border-1)] dark:bg-[var(--surface-4)]',
