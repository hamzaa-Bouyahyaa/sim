...
export function Chat() {
  ...
  return (
    <div
      ...
      style={{
        insetInlineStart: `${actualPosition.x}px`,
    ...
    >
        ...
        >
          {shouldShowConfigureStartInputsButton && (
            <div
              ...
              title={t('chat.addInputsToStart')}
              onMouseDown={(e) => {
                e.stopPropagation()
                handleConfigureStartInputs()
              }}
            >
              <span className='whitespace-nowrap'>{t('chat.addInputs')}</span>
            </div>
          )}
      ...
      <div className='flex flex-1 flex-col overflow-hidden'>
        ...
        >
          ...
          <div
            className={`rounded-[4px] border bg-[var(--surface-5)] py-0 pr-[6px] rtl:pr-[4px] pl-[4px] rtl:pl-[6px] transition-colors ${
          ...
          >
                  ...
                  return (
                    ...
                    >
                      ...
                      <Button
                        ...
                        className='absolute top-0.5 right-0.5 rtl:right-auto rtl:left-0.5 h-4 w-4 p-0 opacity-0 transition-opacity group-hover:opacity-100'
                      >
            ...
            <div className='relative'>
              <Input
                ...
                placeholder={isDragOver ? t('chat.dropFiles') : t('chat.typePlaceholder')}
                className='w-full border-0 bg-transparent pr-[56px] rtl:pr-[4px] pl-[4px] rtl:pl-[56px] shadow-none focus-visible:ring-0 focus-visible:ring-offset-0'
                disabled={!activeWorkflowId}
              />

              {/* Buttons positioned absolutely on the right */}
              <div className='-translate-y-1/2 absolute top-1/2 right-[2px] rtl:right-auto rtl:left-[2px] flex items-center gap-[10px]'>
                <Tooltip.Root>
                  ...
                  <Tooltip.Content>{t('chat.attachFile')}</Tooltip.Content>
                </Tooltip.Root>
