  ...
  forwardRef<ToolbarRef, ToolbarProps>(function Toolbar({ isActive = true }: ToolbarProps, ref) {
    ...
    return (
      ...
      >
        ...
        >
          <h2 className='font-medium text-[14px] text-[var(--text-primary)]'>{t('toolbar.title')}</h2>
          <div className='flex shrink-0 items-center gap-[8px]'>
            {!isSearchActive ? (
              ...
              <input
                ...
                className='w-full border-none bg-transparent pr-[2px] rtl:pr-0 rtl:pl-[2px] text-right rtl:text-left font-medium text-[13px] text-[var(--text-primary)] placeholder:text-[#737373] focus:outline-none'
              />
            )}
          </div>
        </div>
