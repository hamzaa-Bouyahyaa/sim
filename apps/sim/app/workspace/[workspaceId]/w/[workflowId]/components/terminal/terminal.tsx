...
export const Terminal = memo(function Terminal() {
  ...
  return (
    <>
      {/* Resize Handle */}
      <div
        className='fixed right-[var(--panel-width)] rtl:right-[var(--sidebar-width)] bottom-[calc(var(--terminal-height)-4px)] left-[var(--sidebar-width)] rtl:left-[var(--panel-width)] z-20 h-[8px] cursor-ns-resize'
      ...
      <aside
        ref={terminalRef}
        className={clsx(
          'terminal-container fixed right-[var(--panel-width)] rtl:right-[var(--sidebar-width)] bottom-0 left-[var(--sidebar-width)] rtl:left-[var(--panel-width)] z-10 overflow-hidden border-[var(--border)] border-t bg-[var(--surface-1)]',
        ...
        <div className='relative flex h-full'>
          ...
          >
            ...
            >
              ...
              <span className={TERMINAL_CONFIG.HEADER_TEXT_CLASS}>{t('terminal.logs')}</span>
                    ...
                    <Tooltip.Root>
                      <Tooltip.Trigger asChild>
                        <Button
                          ...
                          aria-label={t('terminal.sortByTime')}
                      ...
                      <Tooltip.Content>
                        <span>{t('terminal.sortByTime')}</span>
                      </Tooltip.Content>
                    </Tooltip.Root>
                  )}
                    ...
                    <Tooltip.Root>
                      <Tooltip.Trigger asChild>
                        <Link href='/playground'>
                          <Button
                            variant='ghost'
                            aria-label={t('terminal.componentPlayground')}
                            className='!p-1.5 -m-1.5'
                          >
                      ...
                      <Tooltip.Content>
                        <span>{t('terminal.componentPlayground')}</span>
                      </Tooltip.Content>
                    </Tooltip.Root>
                  )}
                    ...
                    <Tooltip.Root>
                      <Tooltip.Trigger asChild>
                        <Button
                          ...
                          aria-label={isTraining ? t('terminal.stopTraining') : t('terminal.trainCopilot')}
                          className={clsx(
                            '!p-1.5 -m-1.5',
                      ...
                      <Tooltip.Content>
                        <span>{isTraining ? t('terminal.stopTraining') : t('terminal.trainCopilot')}</span>
                      </Tooltip.Content>
                    </Tooltip.Root>
                  )}
