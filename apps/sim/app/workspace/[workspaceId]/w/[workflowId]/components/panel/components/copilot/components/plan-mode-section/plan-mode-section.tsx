  ...
  return (
    ...
    >
          ...
          {isEditing ? (
            <>
              <Button
                ...
                aria-label={t('copilot.planMode.cancelEditing')}
              >
              ...
              <Button
                ...
                className='h-[18px] w-[18px] p-0 hover:text-[var(--text-primary)]'
                onClick={handleSave}
                aria-label={t('copilot.planMode.saveChanges')}
              >
            ...
            <>
              {onBuildPlan && (
                <Button
                  ...
                  title={t('copilot.planMode.buildFromPlan')}
                >
                  {t('copilot.planMode.buildPlan')}
                </Button>
              )}
              {onSave && (
                <Button
                  ...
                  className='h-[18px] w-[18px] p-0 hover:text-[var(--text-primary)]'
                  onClick={handleEdit}
                  aria-label={t('copilot.planMode.editPlan')}
                >
              ...
              {onClear && (
                <Button
                  ...
                  className='h-[18px] w-[18px] p-0 hover:text-[var(--text-primary)]'
                  onClick={onClear}
                  aria-label={t('copilot.planMode.clearPlan')}
                >
      ...
      <div className='flex-1 overflow-y-auto overflow-x-hidden px-[12px] py-[10px]'>
        {isEditing ? (
          <Textarea
            ...
            placeholder={t('copilot.planMode.placeholder')}
          />
        ) : (
      ...
      <div
        ...
        aria-label={t('copilot.planMode.resizePlan')}
      >
