...
console.log(limits);`
  ...
  const getAsyncExampleTitle = () => {
    switch (asyncExampleType) {
      case 'execute':
        return t('deploy.modal.api.executeJob')
      case 'status':
        return t('deploy.modal.api.checkStatus')
      case 'rate-limits':
        return t('deploy.modal.api.rateLimits')
      default:
        return t('deploy.modal.api.executeJob')
    }
  }
  ...
  return (
    <div className='space-y-[16px]'>
      ...
      <div>
        <div className='mb-[6.5px] flex items-center justify-between'>
          <Label className='block pl-[2px] font-medium text-[13px] text-[var(--text-primary)]'>
            {t('deploy.modal.api.runWorkflow')}
          </Label>
          <Tooltip.Root>
            ...
            <Tooltip.Content>
              <span>{copied.sync ? t('common.copied') : t('common.copy')}</span>
            </Tooltip.Content>
          </Tooltip.Root>
        </div>
        <Code.Viewer
      ...
      <div>
        <div className='mb-[6.5px] flex items-center justify-between'>
          <Label className='block pl-[2px] font-medium text-[13px] text-[var(--text-primary)]'>
            {t('deploy.modal.api.runWorkflowStream')}
          </Label>
          <div className='flex items-center gap-[6px]'>
            <Tooltip.Root>
              ...
              <Tooltip.Content>
                <span>{copied.stream ? t('common.copied') : t('common.copy')}</span>
              </Tooltip.Content>
            </Tooltip.Root>
            <OutputSelect
              ...
              placeholder={t('deploy.modal.api.selectOutputs')}
              valueMode='label'
              align='end'
            />
          </div>
      ...
      <div>
        <div className='mb-[6.5px] flex items-center justify-between'>
          <Label className='block pl-[2px] font-medium text-[13px] text-[var(--text-primary)]'>
            {t('deploy.modal.api.runWorkflowAsync')}
          </Label>
          <div className='flex items-center gap-[6px]'>
            <Tooltip.Root>
              <Tooltip.Trigger asChild>
              ...
              <Tooltip.Content>
                <span>{copied.async ? t('common.copied') : t('common.copy')}</span>
              </Tooltip.Content>
            </Tooltip.Root>
            <Combobox
              size='sm'
              ...
              options={[
                { label: t('deploy.modal.api.executeJob'), value: 'execute' },
                { label: t('deploy.modal.api.checkStatus'), value: 'status' },
                { label: t('deploy.modal.api.rateLimits'), value: 'rate-limits' },
              ]}
