      ...
      <PopoverContent ref={menuRef} align='start' side='bottom' sideOffset={4}>
        ...
        {entry && hasRunId && (
          <>
            ...
            >
              {t('terminal.contextMenu.copyRunId')}
            </PopoverItem>
            <PopoverDivider />
          </>
        )}
        ...
        {entry && !entry.success && (
          <>
            ...
            >
              {t('terminal.contextMenu.fixInCopilot')}
            </PopoverItem>
            <PopoverDivider />
          </>
        )}
        ...
        {entry && (
          <>
            ...
            >
              {t('terminal.contextMenu.filterByBlock')}
            </PopoverItem>
            <PopoverItem
            ...
            >
              {t('terminal.contextMenu.filterByStatus')}
            </PopoverItem>
          </>
        )}
        ...
        >
          {t('terminal.contextMenu.clearConsole')}
        </PopoverItem>
      </PopoverContent>
    </Popover>
  )
