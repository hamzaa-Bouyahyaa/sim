...
import { CircleNode } from '@/app/workspace/[workspaceId]/w/[workflowId]/components/circle-node/circle-node'
import { ConditionalNode } from '@/app/workspace/[workspaceId]/w/[workflowId]/components/conditional-node/conditional-node'
import { DatabaseSchema } from '@/app/workspace/[workspaceId]/w/[workflowId]/components/database-schema/database-schema'
import { MinimalPill } from '@/app/workspace/[workspaceId]/w/[workflowId]/components/minimal-pill/minimal-pill'
import { NoteBlock } from '@/app/workspace/[workspaceId]/w/[workflowId]/components/note-block/note-block'
import { RichCard } from '@/app/workspace/[workspaceId]/w/[workflowId]/components/rich-card/rich-card'
import { StatusNode } from '@/app/workspace/[workspaceId]/w/[workflowId]/components/status-node/status-node'
...
const reactFlowStyles = [
  ...
  '[&_.react-flow__handle]:animate-handle-bounce',
...
const WorkflowContent = React.memo(() => {
  ...
  const derivedNodes = useMemo(() => {
    ...
    Object.entries(blocks).forEach(([, block]) => {
      ...
      // Resolve node type: note → noteBlock, custom nodeType from config, default → workflowBlock
      const nodeType = block.type === 'note' ? 'noteBlock' : (blockConfig.nodeType ?? 'workflowBlock')
      ...
      <div className='relative h-full w-full flex-1'>
        ...
        {isWorkflowReady && (
          <>
            ...
            >
              <Background variant={BackgroundVariant.Lines} gap={20} size={1} color="var(--border-1)" />
              <MiniMap
                nodeStrokeWidth={3}
                zoomable
                pannable
