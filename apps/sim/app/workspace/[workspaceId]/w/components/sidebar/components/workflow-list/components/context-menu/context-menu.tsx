    ...
    >
      ...
      <PopoverContent ref={menuRef} align='start' side='bottom' sideOffset={4}>
        ...
        {showOpenInNewTab && onOpenInNewTab && (
          ...
          >
            {t('contextMenu.workflow.openInNewTab')}
          </PopoverItem>
        )}
        ...
        {showCreate && onCreate && (
          ...
          >
            {t('contextMenu.workflow.createWorkflow')}
          </PopoverItem>
        )}
        {showCreateFolder && onCreateFolder && (
          <PopoverItem
          ...
          >
            {t('contextMenu.workflow.createFolder')}
          </PopoverItem>
        )}
        {showColorChange && onColorChange && (
          <PopoverFolder
            id='color-picker'
            title={t('contextMenu.workflow.changeColor')}
            expandOnHover
        ...
        {showDuplicate && onDuplicate && (
          ...
          >
            {t('contextMenu.workflow.duplicate')}
          </PopoverItem>
        )}
        {showExport && onExport && (
          <PopoverItem
