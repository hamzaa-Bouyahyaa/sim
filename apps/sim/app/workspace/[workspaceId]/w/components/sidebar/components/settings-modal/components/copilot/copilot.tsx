    ...
    <>
      <div className='flex h-full flex-col gap-[16px]'>
        ...
        <div className='flex items-center gap-[8px]'>
          <div className='flex flex-1 items-center gap-[8px] rounded-[8px] border border-[var(--border)] bg-transparent px-[8px] py-[5px] transition-colors duration-100 dark:bg-[var(--surface-4)] dark:hover:border-[var(--border-1)] dark:hover:bg-[var(--surface-5)]'>
            ...
            />
            <Input
              placeholder={t('settings.copilot.searchPlaceholder')}
              value={searchTerm}
      ...
      <Modal open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
        <ModalContent size='sm'>
          <ModalHeader>{t('settings.copilot.createTitle')}</ModalHeader>
          <ModalBody>
            ...
            <div className='mt-[16px] flex flex-col gap-[8px]'>
              ...
              <EmcnInput
                ...
                placeholder={t('settings.copilot.namePlaceholder')}
                className='h-9'
                autoFocus
              />
              {createError && (
          ...
          <ModalFooter>
            ...
            >
              {generateKey.isPending ? t('common.creating') : t('common.create')}
            </Button>
          </ModalFooter>
        </ModalContent>
      </Modal>
      ...
      >
        <ModalContent size='sm'>
          <ModalHeader>{t('settings.copilot.created')}</ModalHeader>
          <ModalBody>
            <p className='text-[12px] text-[var(--text-secondary)]'>
      ...
      <Modal open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <ModalContent size='sm'>
          <ModalHeader>{t('settings.copilot.deleteTitle')}</ModalHeader>
          <ModalBody>
            <p className='text-[12px] text-[var(--text-secondary)]'>
              Deleting{' '}
          ...
          <ModalFooter>
            ...
            <Button
              ...
              disabled={deleteKeyMutation.isPending}
            >
              {deleteKeyMutation.isPending ? t('common.deleting') : t('common.delete')}
            </Button>
          </ModalFooter>
        </ModalContent>
      </Modal>
