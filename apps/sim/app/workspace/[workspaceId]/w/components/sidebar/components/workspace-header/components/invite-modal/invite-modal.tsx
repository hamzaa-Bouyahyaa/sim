  ...
  return (
    ...
    >
      <ModalContent size='md'>
        <ModalHeader>{t('workspace.invite.inviteMembers')} {workspaceName || t('workspace.workspaces')}</ModalHeader>
            ...
            <div className='space-y-[12px]'>
              <div>
                ...
                <TagInput
                  ...
                  placeholder={
                    !userPerms.canAdmin
                      ? t('workspace.invite.onlyAdminsCanInvite')
                      : t('workspace.invite.enterEmails')
                  }
                  placeholderWithTags={t('workspace.invite.addEmail')}
      ...
      <Modal open={!!memberToRemove} onOpenChange={handleRemoveMemberCancel}>
        <ModalContent size='sm'>
          <ModalHeader>{t('workspace.invite.removeMember')}</ModalHeader>
          <ModalBody>
            <p className='text-[12px] text-[var(--text-secondary)]'>
              {t('workspace.invite.removeConfirm')}{' '}
              <span className='font-medium text-[var(--text-primary)]'>
                {memberToRemove?.email}
              </span>{' '}
              {t('workspace.invite.fromWorkspace')}{' '}
          ...
          <ModalFooter>
            ...
            <Button
              ...
              disabled={isRemovingMember}
            >
              {isRemovingMember ? t('common.removing') : t('workspace.invite.removeMember')}
            </Button>
          </ModalFooter>
        </ModalContent>
      </Modal>
      ...
      <Modal open={!!invitationToRemove} onOpenChange={handleRemoveInvitationCancel}>
        <ModalContent size='sm'>
          <ModalHeader>{t('workspace.invite.cancelInvitation')}</ModalHeader>
          <ModalBody>
            <p className='text-[12px] text-[var(--text-secondary)]'>
              {t('workspace.invite.cancelConfirm')}{' '}
              <span className='font-medium text-[var(--text-primary)]'>
          ...
          <ModalFooter>
            ...
            <Button
              ...
              disabled={isRemovingInvitation}
            >
              {isRemovingInvitation ? t('common.cancelling') : t('workspace.invite.cancelInvitation')}
            </Button>
          </ModalFooter>
        </ModalContent>
      </Modal>
