  ...
  return (
    <div className='flex items-center justify-between'>
      <div className='flex items-center gap-[8px]'>
        <Label>{t('settings.creditBalance.title')}</Label>
        ...
        <Modal open={isOpen} onOpenChange={handleOpenChange}>
          <ModalTrigger asChild>
            <Button variant='active' className='h-[32px] rounded-[6px] text-[12px]'>
              {t('settings.creditBalance.addCredits')}
            </Button>
          </ModalTrigger>
          <ModalContent size='sm'>
            <ModalHeader>{t('settings.creditBalance.addCredits')}</ModalHeader>
            <ModalBody>
              {success ? (
                ...
                <div className='space-y-[12px]'>
                  <div className='flex flex-col gap-[8px]'>
                    <Label htmlFor='credit-amount'>{t('settings.creditBalance.amountLabel')}</Label>
                    <div className='relative'>
                      ...
                      <Input
                        ...
                        placeholder={t('settings.creditBalance.amountPlaceholder')}
                        className='pl-[28px]'
