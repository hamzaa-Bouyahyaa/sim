  ...
  return (
    <div className='flex h-full flex-col gap-[20px]'>
      ...
      {subscription.isPaid &&
        ...
        !permissions.isEnterpriseMember && (
          <div className='flex items-center justify-between'>
            <Label>{t('settings.subscription.nextBillingDate')}</Label>
      ...
      {!isLoading && isTeamAdmin && (
        <div className='mt-auto flex items-center justify-between'>
          <div className='flex items-center gap-[6px]'>
            <Label htmlFor='billed-account'>{t('settings.subscription.billedAccount')}</Label>
            <Tooltip.Root>
              <Tooltip.Trigger asChild>
                <Info className='h-[12px] w-[12px] text-[var(--text-secondary)]' />
              </Tooltip.Trigger>
              <Tooltip.Content>
                <span>{t('settings.subscription.billedDescription')}</span>
              </Tooltip.Content>
            </Tooltip.Root>
          </div>
          {workspaceAdmins.length === 0 ? (
            ...
            <div className='w-[200px]'>
              <Combobox
                ...
                placeholder={t('settings.subscription.selectAdmin')}
...
function BillingUsageNotificationsToggle() {
  ...
  return (
    <div className='flex items-center justify-between'>
      <div className='flex flex-col gap-[4px]'>
        <Label htmlFor='usage-notifications'>{t('settings.subscription.usageNotifications')}</Label>
