      ...
      <div>
          ...
          <div className='flex flex-col gap-[16px]'>
            ...
            <div>
              ...
              <Input
                ...
                placeholder={t('settings.team.orgNamePlaceholder')}
                className='mt-[4px]'
            ...
            <div>
              ...
              <div className='mt-[4px] flex items-center'>
                ...
                <Input
                  ...
                  placeholder={t('settings.team.orgSlugPlaceholder')}
            ...
            <div className='flex flex-col gap-[8px]'>
              ...
              <div className='flex justify-end'>
                ...
                >
                  {isCreatingOrg ? t('common.creating') : 'Create Team Workspace'}
                </Button>
              </div>
            </div>
          </div>
        ...
        <Modal open={createOrgDialogOpen} onOpenChange={setCreateOrgDialogOpen}>
          <ModalContent className='sm:max-w-md'>
            <ModalHeader>
              <ModalTitle>{t('settings.team.createOrg')}</ModalTitle>
              <ModalDescription>
