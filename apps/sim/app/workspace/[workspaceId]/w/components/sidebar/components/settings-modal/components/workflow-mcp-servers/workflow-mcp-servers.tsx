    ...
    <>
      ...
      >
        <ModalContent className='w-[480px]'>
            ...
            <div className='flex flex-col gap-[16px]'>
              <div>
                ...
                <Textarea
                  ...
                  placeholder={t('settings.workflowMcp.describeTool')}
          ...
          <ModalFooter>
            ...
            >
              {updateToolMutation.isPending ? t('common.saving') : t('common.save')}
            </Button>
          </ModalFooter>
        </ModalContent>
      </Modal>
      ...
      >
        <ModalContent className='w-[420px]'>
          <ModalHeader>{t('settings.workflowMcp.addWorkflow')}</ModalHeader>
          <ModalBody>
            <p className='text-[12px] text-[var(--text-secondary)]'>
            ...
            <div className='mt-[16px] flex flex-col gap-[8px]'>
              ...
              <Combobox
                ...
                placeholder={t('settings.workflowMcp.selectWorkflow')}
                searchable
      ...
      >
        <ModalContent className='w-[420px]'>
          ...
          <ModalBody>
            <div className='flex flex-col gap-[12px]'>
              ...
              <FormField label='Access'>
                ...
                >
                  <ButtonGroupItem value='private'>{t('settings.workflowMcp.authType.apiKey')}</ButtonGroupItem>
                  <ButtonGroupItem value='public'>{t('settings.workflowMcp.authType.public')}</ButtonGroupItem>
                </ButtonGroup>
              </FormField>
          ...
          <ModalFooter>
            ...
            >
              {updateServerMutation.isPending ? t('common.saving') : t('common.save')}
            </Button>
          </ModalFooter>
        </ModalContent>
      </Modal>
      ...
      <div className='flex h-full flex-col gap-[16px]'>
        <div className='flex items-center gap-[8px]'>
          <div className='flex flex-1 items-center gap-[8px] rounded-[8px] border border-[var(--border)] bg-transparent px-[8px] py-[5px] transition-colors duration-100 dark:bg-[var(--surface-4)] dark:hover:border-[var(--border-1)] dark:hover:bg-[var(--surface-5)]'>
            ...
            />
            <Input
              placeholder={t('settings.workflowMcp.searchServers')}
              value={searchTerm}
