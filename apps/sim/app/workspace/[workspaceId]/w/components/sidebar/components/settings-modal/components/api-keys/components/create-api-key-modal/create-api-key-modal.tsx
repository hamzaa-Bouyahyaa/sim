    ...
    <>
      ...
      <Modal open={open} onOpenChange={onOpenChange}>
        <ModalContent size='sm'>
          <ModalHeader>{t('settings.apiKeys.createTitle')}</ModalHeader>
          <ModalBody>
          ...
          <ModalFooter>
            ...
            >
              {createApiKeyMutation.isPending ? t('common.creating') : t('common.create')}
            </Button>
          </ModalFooter>
        </ModalContent>
      </Modal>
      ...
      >
        <ModalContent size='sm'>
          <ModalHeader>{t('settings.apiKeys.created')}</ModalHeader>
          <ModalBody>
            <p className='text-[12px] text-[var(--text-secondary)]'>
