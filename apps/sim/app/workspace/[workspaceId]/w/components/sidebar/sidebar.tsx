  ...
  return (
    <>
      {isCollapsed ? (
        ...
        <div className='fixed top-[14px] left-[10px] rtl:left-auto rtl:right-[10px] z-10 w-fit rounded-[8px] border border-[var(--border)] bg-[var(--surface-1)] py-[4px] pr-[10px] rtl:pr-[6px] pl-[6px] rtl:pl-[10px]'>
          <WorkspaceHeader
        ...
        <>
          <aside
            ref={sidebarRef}
            className='sidebar-container fixed inset-y-0 left-0 rtl:left-auto rtl:right-0 z-10 overflow-hidden bg-[var(--surface-1)]'
            aria-label='Workspace sidebar'
            onClick={handleSidebarClick}
          >
            <div className='flex h-full flex-col border-[var(--border)] border-r rtl:border-r-0 rtl:border-l pt-[12px]'>
              {/* Header */}
                    ...
                    <div className='flex items-center justify-center gap-[10px]'>
                      ...
                      <Tooltip.Root>
                        <Tooltip.Trigger asChild>
                          <Button
                            variant='ghost'
                            className='mr-[1px] rtl:mr-0 rtl:ml-[1px] translate-y-[-0.25px] p-[1px]'
                        ...
                        <Tooltip.Content>
                          <p>{isCreatingFolder ? t('sidebar.creatingFolder') : t('sidebar.createFolder')}</p>
                        </Tooltip.Content>
                      </Tooltip.Root>
                      <Tooltip.Root>
                        <Tooltip.Trigger asChild>
                        ...
                        <Tooltip.Content>
                          <p>{isCreatingWorkflow ? t('sidebar.creatingWorkflow') : t('sidebar.createWorkflow')}</p>
                        </Tooltip.Content>
                      </Tooltip.Root>
                    </div>
                  </div>
          ...
          {isOnWorkflowPage && (
            <div
              className='fixed top-0 bottom-0 left-[calc(var(--sidebar-width)-4px)] rtl:left-auto rtl:right-[calc(var(--sidebar-width)-4px)] z-20 w-[8px] cursor-ew-resize'
