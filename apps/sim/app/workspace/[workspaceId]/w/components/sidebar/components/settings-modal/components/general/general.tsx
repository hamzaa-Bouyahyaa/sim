...
export function General({ onOpenChange }: GeneralProps) {
  ...
  return (
    <div className='flex h-full flex-col gap-[16px]'>
      ...
      <div className='flex items-center justify-between'>
        <Label htmlFor='auto-connect'>{t('settings.general.autoConnect')}</Label>
        <Switch
          id='auto-connect'
      ...
      <div className='flex items-center justify-between'>
        <Label htmlFor='error-notifications'>{t('settings.general.errorNotifications')}</Label>
        <Switch
      ...
      <div className='flex items-center justify-between'>
        <Label htmlFor='snap-to-grid'>{t('settings.general.snapToGrid')}</Label>
        <div className='w-[100px]'>
          <Combobox
            size='sm'
            align='end'
      ...
      <div className='flex items-center justify-between'>
        <Label htmlFor='show-action-bar'>{t('settings.general.showCanvasControls')}</Label>
        <Switch
          id='show-action-bar'
      ...
      <div className='flex items-center justify-between border-t pt-[16px]'>
        <Label htmlFor='telemetry'>{t('settings.general.telemetry')}</Label>
        <Switch
          id='telemetry'
      ...
      {isTrainingEnabled && (
        <div className='flex items-center justify-between'>
          <Label htmlFor='training-controls'>{t('settings.general.trainingControls')}</Label>
          <Switch
      ...
      {!loadingSuperUser && isSuperUser && (
        <div className='flex items-center justify-between'>
          <Label htmlFor='super-user-mode'>{t('settings.general.superAdminMode')}</Label>
          <Switch
            id='super-user-mode'
