  ...
  return (
    <>
        ...
        <ModalContent size='sm'>
          <ModalHeader>
            <div className='flex items-center justify-between'>
              <span>{t('knowledge.tags.tags')}</span>
            </div>
          </ModalHeader>
                ...
                {isCreatingTag && (
                  <div className='space-y-[8px] rounded-[6px] border p-[12px]'>
                    <div className='flex flex-col gap-[8px]'>
                      <Label htmlFor='tagName'>{t('knowledge.tags.tagName')}</Label>
                      <Input
                        id='tagName'
                    ...
                    <div className='flex flex-col gap-[8px]'>
                      <Label htmlFor='tagType'>{t('common.type')}</Label>
                      <Combobox
                        ...
                        placeholder={t('knowledge.tags.selectType')}
                      />
      ...
      <Modal open={deleteTagDialogOpen} onOpenChange={setDeleteTagDialogOpen}>
        <ModalContent size='sm'>
          <ModalHeader>{t('knowledge.tags.deleteTag')}</ModalHeader>
          <ModalBody>
            <div className='space-y-[8px]'>
              ...
              {selectedTagUsage && selectedTagUsage.documentCount > 0 && (
                <div className='flex flex-col gap-[8px]'>
                  <Label>{t('knowledge.tags.affectedDocuments')}</Label>
                  <DocumentList
