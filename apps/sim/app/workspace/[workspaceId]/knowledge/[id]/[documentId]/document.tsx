              ...
              <Input
                placeholder={
                  documentData?.processingStatus === 'completed'
                    ? t('knowledge.documents.searchPlaceholder')
                    : t('knowledge.loadingText')
                }
                value={searchQuery}
          ...
          >
            {displayChunks.length === 0 && documentData?.processingStatus === 'completed' ? (
              <div className='mt-[10px] flex h-64 items-center justify-center rounded-lg border border-muted-foreground/25 bg-muted/20'>
                <div className='text-center'>
                  <p className='font-medium text-[var(--text-secondary)] text-sm'>
                    {searchQuery ? t('knowledge.noResults') : t('knowledge.noKnowledgeBases')}
                  </p>
                            ...
                            <div className='flex items-center gap-[4px]'>
                              ...
                              <Tooltip.Root>
                                ...
                                <Tooltip.Content side='top'>
                                  {!userPermissions.canEdit
                                    ? t('knowledge.writePermRequired')
                                    : t('knowledge.chunks.deleteChunk')}
                                </Tooltip.Content>
                              </Tooltip.Root>
                            </div>
                          </TableCell>
        ...
        <ModalContent size='sm'>
          ...
          <ModalFooter>
            ...
            <Button
              ...
              disabled={isDeletingDocument}
            >
              {isDeletingDocument ? t('common.deleting') : t('common.delete')}
            </Button>
          </ModalFooter>
        </ModalContent>
      </Modal>
