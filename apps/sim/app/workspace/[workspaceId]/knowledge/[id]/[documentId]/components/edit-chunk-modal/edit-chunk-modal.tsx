    ...
    <>
        ...
        <ModalContent size='lg'>
          <ModalHeader>
            <div className='flex items-center gap-[8px]'>
              <span>{t('knowledge.chunks.editChunk')} #{chunk.chunkIndex}</span>
              {/* Navigation Controls */}
              <div className='flex items-center gap-[6px]'>
                <Tooltip.Root>
                  ...
                  <Tooltip.Content side='bottom'>
                    {t('knowledge.chunks.previousChunk')}
                  </Tooltip.Content>
                </Tooltip.Root>
          ...
          <form>
            <ModalBody>
              <div className='flex flex-col gap-[8px]'>
                ...
                <Label htmlFor='content'>{t('knowledge.chunks.chunkLabel')}</Label>
                {tokenizerOn ? (
                  ...
                  <Textarea
                    ...
                    placeholder={
                      userPermissions.canEdit ? t('knowledge.chunks.chunkContentPlaceholder') : t('knowledge.chunks.readOnlyView')
                    }
                    rows={20}
              ...
              <div className='flex items-center justify-between pt-[12px]'>
                <div className='flex items-center gap-[8px]'>
                  <span className='text-[12px] text-[var(--text-secondary)]'>{t('knowledge.chunks.tokenizer')}</span>
                ...
                <span className='text-[12px] text-[var(--text-secondary)]'>
                  ...
                  {maxChunkSize !== undefined && `/${maxChunkSize.toLocaleString()}`} {t('knowledge.chunks.tokens')}
                </span>
              </div>
            </ModalBody>
      ...
      <Modal open={showUnsavedChangesAlert} onOpenChange={setShowUnsavedChangesAlert}>
        <ModalContent size='sm'>
          <ModalHeader>{t('knowledge.chunks.discardChanges')}</ModalHeader>
          <ModalBody>
            <p className='text-[12px] text-[var(--text-secondary)]'>
              {pendingNavigation
                ? t('knowledge.chunks.unsavedNavChanges')
                : t('knowledge.chunks.unsavedCloseChanges')}
            </p>
          </ModalBody>
          <ModalFooter>
            <Button
