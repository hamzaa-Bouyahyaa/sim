    ...
    <>
      <Modal open={open} onOpenChange={handleCloseAttempt}>
        <ModalContent size='lg'>
          <ModalHeader>{t('knowledge.chunks.createChunk')}</ModalHeader>
          ...
          <form>
            <ModalBody>
              <div className='flex flex-col gap-[8px]'>
                ...
                <Textarea
                  ...
                  placeholder={t('knowledge.chunks.chunkPlaceholder')}
                  rows={12}
                  disabled={isCreating}
                />
              </div>
            ...
            <ModalFooter>
              ...
              >
                {isCreating ? t('knowledge.chunks.creatingChunk') : t('knowledge.chunks.createChunkButton')}
              </Button>
            </ModalFooter>
          </form>
        </ModalContent>
        ...
        <ModalContent size='sm'>
          ...
          <ModalBody>
            <p className='text-[12px] text-[var(--text-secondary)]'>
              {t('knowledge.chunks.unsavedChanges')}
            </p>
          </ModalBody>
          <ModalFooter>
            <Button
