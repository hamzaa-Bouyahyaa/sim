  ...
  return (
    <Modal open={open} onOpenChange={handleClose}>
      <ModalContent size='lg'>
        <ModalHeader>{t('knowledge.create.title')}</ModalHeader>
            ...
            <div ref={scrollContainerRef} className='min-h-0 flex-1 overflow-y-auto'>
              <div className='space-y-[12px]'>
                <div className='flex flex-col gap-[8px]'>
                  <Label htmlFor='kb-name'>{t('knowledge.create.nameLabel')}</Label>
                ...
                <div className='flex flex-col gap-[8px]'>
                  <Label htmlFor='description'>{t('knowledge.create.descriptionLabel')}</Label>
                  <Textarea
                    id='description'
                ...
                <div className='grid grid-cols-2 gap-[12px]'>
                  <div className='flex flex-col gap-[8px]'>
                    <Label htmlFor='minChunkSize'>{t('knowledge.create.minChunkSize')}</Label>
                    <Input
                      id='minChunkSize'
                      placeholder='100'
                  ...
                  <div className='flex flex-col gap-[8px]'>
                    <Label htmlFor='maxChunkSize'>{t('knowledge.create.maxChunkSize')}</Label>
                    <Input
                      id='maxChunkSize'
                      placeholder='1024'
                ...
                <div className='flex flex-col gap-[8px]'>
                  <Label htmlFor='overlapSize'>{t('knowledge.create.overlap')}</Label>
                  <Input
                    id='overlapSize'
                    placeholder='200'
                ...
                <div className='flex flex-col gap-[8px]'>
                  <Label>{t('knowledge.create.uploadDocuments')}</Label>
                  <Button
                    type='button'
                    variant='default'
                  ...
                  >
                    ...
                    <div className='flex flex-col gap-[2px] text-center'>
                      <span className='text-[var(--text-primary)]'>
                        {isDragging ? t('knowledge.create.dropFiles') : t('knowledge.create.dropOrBrowse')}
                      </span>
                      <span className='text-[11px] text-[var(--text-tertiary)]'>
                        {t('knowledge.create.fileTypes')}
                      </span>
                    </div>
                  </Button>
                </div>
                ...
                {files.length > 0 && (
                  <div className='space-y-2'>
                    <Label>{t('knowledge.create.selectedFiles')}</Label>
                    <div className='space-y-2'>
                  ...
                  {isSubmitting
                    ? isUploading
                      ? uploadProgress.stage === 'uploading'
                        ? `${t('knowledge.create.uploading')} ${uploadProgress.filesCompleted}/${uploadProgress.totalFiles}...`
                        : uploadProgress.stage === 'processing'
                          ? t('knowledge.create.processing')
