  ...
  return (
    <Modal open={open} onOpenChange={onOpenChange}>
      <ModalContent size='sm'>
        <ModalHeader>{t('knowledge.editModal.title')}</ModalHeader>

        <form onSubmit={handleSubmit(onSubmit)} className='flex min-h-0 flex-1 flex-col'>
          <ModalBody>
            <div className='space-y-[12px]'>
              <div className='flex flex-col gap-[8px]'>
                <Label htmlFor='kb-name'>{t('knowledge.editModal.nameLabel')}</Label>
                <Input
                  id='kb-name'
                  placeholder={t('knowledge.editModal.namePlaceholder')}
                  {...register('name')}
              ...
              <div className='flex flex-col gap-[8px]'>
                <Label htmlFor='description'>{t('knowledge.editModal.descriptionLabel')}</Label>
                <Textarea
                  id='description'
                  placeholder={t('knowledge.editModal.descriptionPlaceholder')}
                  rows={4}
