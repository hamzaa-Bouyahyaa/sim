            ...
            <div className='flex items-center gap-2'>
              ...
              {!hasWorkspace && (
                <Tooltip.Root>
                  ...
                  <Tooltip.Content side='top'>{t('knowledge.noWorkspace')}</Tooltip.Content>
                </Tooltip.Root>
              )}
              ...
              <Popover open={isWorkspacePopoverOpen} onOpenChange={setIsWorkspacePopoverOpen}>
                    ...
                    <span className='truncate'>
                      {isLoadingWorkspaces
                        ...
                        : updateKnowledgeBase.isPending
                          ? t('knowledge.updatingText')
                          : currentWorkspace?.name || t('knowledge.noWorkspace')}
                    </span>
                ...
                <PopoverContent align='end' side='bottom' sideOffset={4}>
                  ...
                  >
                    <span className='text-muted-foreground'>{t('knowledge.noWorkspace')}</span>
                  </PopoverItem>
            ...
            <Popover open={isActionsPopoverOpen} onOpenChange={setIsActionsPopoverOpen}>
              <PopoverTrigger asChild>
                <Button
                  variant='outline'
                  className={filterButtonClass}
                  aria-label={t('knowledge.actionsMenu')}
                >
