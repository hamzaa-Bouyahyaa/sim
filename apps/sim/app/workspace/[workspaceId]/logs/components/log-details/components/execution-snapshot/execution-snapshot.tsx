      ...
      return (
        ...
        >
          <div className='flex items-center gap-[8px] text-[var(--text-secondary)]'>
            ...
            <span className='text-[13px]'>{t('logs.loadingLogs')}</span>
          </div>
        </div>
      )
    }
      ...
      return (
        ...
        >
          <div className='flex items-center gap-[8px] text-[var(--text-error)]'>
            ...
            <span className='text-[13px]'>{t('logs.failedToLoad')}: {error.message}</span>
          </div>
        </div>
      )
    }
      ...
      ? createPortal(
          ...
          >
            ...
            <PopoverContent ref={menuRef} align='start' side='bottom' sideOffset={4}>
              <PopoverItem onClick={handleCopyExecutionId}>{t('logs.logContextMenu.copyExecutionId')}</PopoverItem>
            </PopoverContent>
          </Popover>,
          document.body
        )
      ...
      <>
        ...
        >
          <ModalContent size='full' className='flex h-[90vh] flex-col'>
            <ModalHeader>{t('logs.details.workflowState')}</ModalHeader>
