  ...
  return (
    ...
    >
      ...
      <PopoverContent ref={menuRef} align='start' side='bottom' sideOffset={4}>
        ...
        >
          {t('logs.logContextMenu.copyExecutionId')}
        </PopoverItem>
        ...
        >
          {t('logs.logContextMenu.openWorkflow')}
        </PopoverItem>
        <PopoverItem
          disabled={!hasExecutionId}
          onClick={() => {
        ...
        >
          {t('logs.logContextMenu.openSnapshot')}
        </PopoverItem>
        ...
        {!isFilteredByThisWorkflow && (
          ...
          >
            {t('logs.logContextMenu.filterByWorkflow')}
          </PopoverItem>
        )}
        {hasActiveFilters && (
          <PopoverItem
          ...
          >
            {t('logs.logContextMenu.clearFilters')}
          </PopoverItem>
        )}
      </PopoverContent>
    </Popover>
