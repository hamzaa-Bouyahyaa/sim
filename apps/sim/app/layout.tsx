...
import { LocaleProvider } from '@/app/_shell/providers/locale-provider'
    ...
    <html lang='ar' dir='rtl' suppressHydrationWarning>
      <head>
        ...
        */}
        ...
        {/* Locale direction: set dir/lang before hydration to avoid layout flash */}
        <script
          id='locale-direction'
          dangerouslySetInnerHTML={{
            __html: `
              (function () {
                try {
                  var stored = localStorage.getItem('locale-state');
                  if (stored) {
                    var parsed = JSON.parse(stored);
                    var state = parsed && parsed.state;
                  ...
                  // Defaults (ar/rtl) are set on the html tag
                }
              })();
            `,
          }}
